...
public class Usuarios {
    ...
    public Usuarios(int id_Usuario, String dni_Usuario, String nombre_Usuario,
            int tipo_Usuario, String ntipo_Usuario, String correo,  String telefono, String contrasenia) {
...
//========= Para el nombre del usuario en la pantalla
...
//========    
    ...
    public int hashCode() {
        ...
        hash = 61 * hash + Objects.hashCode(this.tipo_Usuario);
        hash = 61 * hash + Objects.hashCode(this.correo);
        hash = 61 * hash + Objects.hashCode(this.telefono);
        hash = 61 * hash + Objects.hashCode(this.contrasenia);
        return hash;
    }
