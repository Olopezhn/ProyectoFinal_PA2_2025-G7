...
public class FormularioLibros extends javax.swing.JDialog {
    ...
    public FormularioLibros(ListadoLibros pParent, boolean modal, String pMode, int pId_Libro) {
        ...
        if(mode.equals("INS")){
            ...
            txt_autor.setText(String.valueOf(libro.getId_Autor()));        
            ...
            txt_autor.setText(String.valueOf(libro.getId_Autor()));
            txt_autor.setFont(new java.awt.Font("Segoe UI", 0, 18)); // Tamaño de fuente
            txt_autor.setPreferredSize(new java.awt.Dimension(200, 30)); // Ancho y alto deseado
            ...
            btnBuscarAutor.setEnabled(false);
    ...
    private void initComponents() {
        ...
        cboCategoria.setMinimumSize(new java.awt.Dimension(72, 31));

        lbl_autor.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lbl_autor.setText("Autor:");

        txt_autor.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_edicion, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lbl_autor, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_autor, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txt_autor, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnBuscarAutor))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_edicion, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBuscarAutorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarAutorActionPerformed
        // TODO add your handling code here:
      SeleccionarAutorDialog dialog = new SeleccionarAutorDialog(parent, true);
        dialog.setLocationRelativeTo(this);
        dialog.setVisible(true);


        String autorSeleccionado = dialog.getAutorSeleccionado();
        if (autorSeleccionado != null && !autorSeleccionado.isEmpty()) {
         try {
            id_Autor = Integer.parseInt(autorSeleccionado); 
            txt_autor.setText(autorSeleccionado); 
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "El ID del autor es invalido.");
    }
}
    ...
    if (itemSeleccionado != null && itemSeleccionado.contains(" - ")) {
        ...
        try {
            return Integer.parseInt(partes[0]); // Retorna el numero antes del guion
        } catch (NumberFormatException e) {
            e.printStackTrace();
        }
    }
