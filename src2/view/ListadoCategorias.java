...
public class ListadoCategorias extends javax.swing.JFrame {
    ...
    tbl_categorias.getColumnModel().getColumn(0).setPreferredWidth(10);   
    tbl_categorias.getColumnModel().getColumn(1).setPreferredWidth(140);  
    
    
    // Evita que el usuario cambie el tamaño
    for (int i = 0; i < tbl_categorias.getColumnCount(); i++) {
        tbl_categorias.getColumnModel().getColumn(i).setResizable(false);
    }
    }
