...
public class LibrosDAO {
   ...
   public List<Object> getAll(){
       ...
       String queryLibros = "select l.id_libro, l.titulo_libro, l.id_categoria, c.nombre_categoria, a.id_autor, a.nombre_autor, l.edicion, l.editorial, l.fecha_publicacion from libros AS l inner join categorias  AS c on l.id_categoria = c.id_categoria inner join autores AS a on l.id_autor = a.id_autor ORDER BY L.id_libro ASC;";
       try (Connection con = ConnectionDB.getConnection()){
           ...
           while(lista.next()){
                listado.add(new Libros(lista.getInt("id_Libro")
                        ...
                        ,lista.getInt("id_Autor")
                        ,lista.getString("nombre_Autor")
   ...
   public boolean insert(Object object){
       ...
       String sql = "INSERT INTO libros (titulo_libro,id_categoria,id_autor,edicion,editorial,fecha_publicacion) VALUES (?,?,?,?,?,?);";
       try(Connection con = ConnectionDB.getConnection()){
           PreparedStatement pst = con.prepareStatement(sql);
           pst.setString(1, libros.getTitulo_Libro());
           pst.setInt(2, libros.getId_Categoria());
           pst.setInt(3, libros.getId_Autor());
           pst.setInt(4, libros.getEdicion());
           pst.setString(5, libros.getEditorial());                    
           pst.setDate(6, libros.getFecha_Publicacion());
   ...
   public boolean update(Object object){
       ...
       String sql = "UPDATE libros SET titulo_libro = ?, id_categoria = ? , id_autor = ?, edicion = ?, editorial = ?, fecha_publicacion = ? WHERE id_libro = ?";
       ...
       try(Connection con = ConnectionDB.getConnection()){
           ...
           pst.setString(1, libros.getTitulo_Libro());
            ...
            pst.setString(5, libros.getEditorial());
            pst.setDate(6, libros.getFecha_Publicacion());
            pst.setInt(7, libros.getId_Libro());
   ...
   public Object getById(int id_libro){            
       ...
       String queryLibros = "SELECT l.id_libro, l.titulo_libro, l.id_categoria, c.nombre_categoria, a.id_autor, a.nombre_autor, l.edicion, l.editorial, l.fecha_publicacion " +
                         "FROM libros l " +
                         "INNER JOIN categorias c ON l.id_categoria = c.id_categoria inner join autores AS a on l.id_autor = a.id_autor " +
                         "WHERE l.id_libro = ?;";
       ...
       try (Connection con = ConnectionDB.getConnection()){
           ...
           while(resultado.next()){                
               ...
               libro.setId_Autor(resultado.getInt("id_autor"));
               libro.setnombre_Autor(resultado.getString("nombre_autor"));
