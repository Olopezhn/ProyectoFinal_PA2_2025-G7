...
public class UsuariosDAO {
   ...
   public boolean insert(Object object){
       ...
       String sql = "insert INTO usuarios (dni_usuario,nombre_usuario,tipo_usuario,correo,telefono,contrasenia) VALUES (?,?,?,?,?,?);";
       try(Connection con = ConnectionDB.getConnection()){
           ...
           pst.setString(6, usuarios.getcontrasenia());
   ...
   public boolean update(Object object){
       ...
       String sql = "UPDATE usuarios SET dni_usuario = ?, nombre_usuario = ?, tipo_usuario = ?, correo = ?, telefono = ? , contrasenia = ? WHERE id_usuario = ?";
       ...
       try(Connection con = ConnectionDB.getConnection()){
           PreparedStatement pst = con.prepareStatement(sql);
            ...
            pst.setString(5, usuarios.gettelefono());           
            pst.setString(6, usuarios.getcontrasenia());
             pst.setInt(7, usuarios.getId_Usuario());
